...
public class MyOctaveKernel extends MyProcess{
	public MyOctaveKernel(){
		this.setIdPrefix("kernel_");
	}
	...
	public void makeInputFile(String data) throws Exception{
		...
		bw.write(data + ";\n");
		bw.write("kernel = null(A);\n");
		bw.write("save_precision(24);\n");
		bw.write("save " + this.getOutputFile() + " kernel;");
		bw.close();
	}
